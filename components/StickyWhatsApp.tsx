  ...
  return (
    ...
    >
      <div className="relative group cursor-pointer">
        ...
        {/* Tooltip */}
        <span className="absolute right-16 top-1/2 -translate-y-1/2 bg-[#0A0A0A] text-white text-xs font-medium px-3 py-1.5 rounded-lg border border-[#333] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
          Chat on WhatsApp
        </span>
      </div>
    </a>
